...
public class MatricesTest {
    ...
    public void testSumMatrix() {
        ...
        matrix1.setAt(0, 0, 1.0);
        matrix1.setAt(0, 1, 2.0);
        matrix1.setAt(1, 0, 3.0);
        matrix1.setAt(1, 1, 4.0);
        ...
        assertEquals(sumMatrix.getAt(0, 0), 0.0);
        assertEquals(sumMatrix.getAt(0, 1), 0.0);
        assertEquals(sumMatrix.getAt(1, 0), 0.0);
        assertEquals(sumMatrix.getAt(1, 1), 0.0);
